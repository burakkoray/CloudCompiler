...
@if(Auth::check())
    ...
    <div id="image" style="display:none; position:relative;"><img src="" alt="" style="display:block; padding:0; max-height:90%; max-width:90%;" /></div>
...
//var directory= " public_path().DIRECTORY_SEPARATOR.'user-files' . DIRECTORY_SEPARATOR . Auth::user()->username . DIRECTORY_SEPARATOR"
//exec(directory+"main" , $out);
//document.write($out);
